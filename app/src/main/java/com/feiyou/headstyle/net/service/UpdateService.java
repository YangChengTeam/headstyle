...
public class UpdateService extends Service {
	...
	private void createNotification() {
		...
		notification = new Notification(R.drawable.logo, "开始下载新版本", System.currentTimeMillis());
	...
	private class DownLoadThread extends Thread {
		...
		public void run() {
			...
			downloadFile = new DownloadFile(url, Constant.BASE_NORMAL_FILE_DIR + "/gxtx.apk");

			File file = new File(Constant.BASE_NORMAL_FILE_DIR + "/gxtx.apk");
			if (file.exists()) {
				file.delete();
			}
			...
			if (downloadFile.downloadFile()) {
				...
				intent.setDataAndType(Uri.fromFile(new File(Constant.BASE_NORMAL_FILE_DIR + "/gxtx.apk")),
