...
public class ArticleNewListAdapter extends BaseQuickAdapter<ArticleInfo, BaseViewHolder> {

    private Context mContext;

    private List<ArticleInfo> articleData = new ArrayList<>();
    ...
    public ArticleNewListAdapter(Context context, List<ArticleInfo> datas) {
        super(R.layout.article_list_item, datas);
        this.mContext = context;
        this.articleData = datas;
        okHttpRequest = new OKHttpRequest();
        articleService = new ArticleService();
        if (showImageUrlList == null) {
