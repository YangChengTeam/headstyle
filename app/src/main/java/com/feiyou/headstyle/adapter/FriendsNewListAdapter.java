...
public class FriendsNewListAdapter extends BaseQuickAdapter<ArticleInfo,BaseViewHolder> {
    ...
    public FriendsNewListAdapter(Context context, List<ArticleInfo> datas) {
