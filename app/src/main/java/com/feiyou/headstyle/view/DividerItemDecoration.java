...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private void drawVertical(Canvas c, RecyclerView parent) {
        int left = parent.getPaddingLeft() + ScreenUtils.dpToPxInt(mContext,10);
        int right = parent.getWidth() - parent.getPaddingRight() - ScreenUtils.dpToPxInt(mContext,10); //减去内边距
