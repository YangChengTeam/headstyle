...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "HeadStyle";
    ...
    public static boolean putObject(Context context, String key, Object obj) {
        if (obj != null) {
            String result = Constant.GSON.toJson(obj);
            return putString(context, key, result);
        } else {
            return putString(context, key, null);
        }
    }
    ...
    public static Object getObject(Context context, String key, Class clazz) {
        String result = getString(context, key, null);
        if (!StringUtils.isEmpty(result)) {
            return Constant.GSON.fromJson(result, clazz);
        }
        return null;
    }
