...
import com.feiyou.headstyle.view.MyHighlightView;
import com.feiyou.headstyle.view.MyImageViewDrawableOverlay;
import com.feiyou.headstyle.view.StickerDrawable;
...
public class EffectUtil {
    ...
    static {
        addonList.add(new Addon(R.mipmap.s1));
        addonList.add(new Addon(R.mipmap.s2));
        addonList.add(new Addon(R.mipmap.s3));
        addonList.add(new Addon(R.mipmap.s4));
        addonList.add(new Addon(R.mipmap.s5));
        addonList.add(new Addon(R.mipmap.s6));
        addonList.add(new Addon(R.mipmap.s7));
        addonList.add(new Addon(R.mipmap.s8));
    }
    ...
    private static void applyOnSave(Canvas mCanvas, ImageViewTouch processImage,MyHighlightView view) {
        ...
        if (view != null && view.getContent() instanceof StickerDrawable) {
            ...
            int saveCount = mCanvas.save(Canvas.ALL_SAVE_FLAG);
